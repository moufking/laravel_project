        ...
        <div class="col-md-8">
            ...
            <div class="bg-white">
                <div class="card-header bg-admin-base  text-center bg-admin-base  text-white text-bold">
                    TheTipTop Administration | Ajout d'un nouvel utilisateur
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="role" class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}" name="role" required>
                                    <option value="">--</option>
                                    <option value="{{env('ADMIN_ROLE')}}">Admin </option>
                                    <option value="{{env("EMPLOYEE_ROLE")}}">Employé</option>
                                </select>
                                @if ($errors->has('role'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            <label for="telephone" class="col-md-4 col-form-label text-md-right">Mot de passe</label>

                            <div class="col-md-6">
                                <input id="telephone" type="text" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="{{ old('password') }}" required>
                        ...
                        <div class="form-group row">
                            <label for="telephone" class="col-md-4 col-form-label text-md-right">Confirmation mot de passe</label>

                            <div class="col-md-6">
                                <input id="telephone" type="text" class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" name="password_confirmation" value="{{ old('password_confirmation') }}" required>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn bg-admin-base ">
                                    <i class="fas fa-check"></i> Enregistrer l'utilisateur
                                </button>
                            </div>
                        </div>
                    </form>
