...
return [
    ...
    */
    ...
    'date_format'          => 'Ce ne correspond pas au format :format.',
    ...
    'distinct'             => 'Ce a une valeur en double.',
    'email'                => 'Ce champ doit être une adresse courriel valide.',
    'exists'               => 'Ce sélectionné est invalide.',
    ...
    'in_array'             => "Ce n'existe pas dans :other.",
    ...
    'not_in'               => "Ce sélectionné n'est pas valide.",
